...
const showContainer = () => {
  ...
  <div class="about__container--2--container--container">
    <div class="about__container--2--container--container--1">
      <button class="about__container--2--container--container--1--btn active" id="btn1">¿Qué hacemos? <i class="fa-sharp fa-solid fa-block-brick"></i> <i class="fa-solid fa-helmet-safety"></i></button>
      <button class="about__container--2--container--container--1--btn" id="btn2">¿Qué usamos? <i class="fa-solid fa-hammer"></i></button>
    </div>
